...
typedef struct {
    ...
    uint8_t ship_id[GRID_SIZE][GRID_SIZE];
...
int  can_place_ship(char grid[GRID_SIZE][GRID_SIZE], uint8_t ship_id[GRID_SIZE][GRID_SIZE],
                    int row, int col, char dir, int len);
void place_ship    (char grid[GRID_SIZE][GRID_SIZE], uint8_t ship_id[GRID_SIZE][GRID_SIZE],
                    int row, int col, char dir, int len);

// shots
int  apply_shot   (Game *game, int target_idx, int row, int col); // 'H', 'M', or 0
int  is_ship_sunk (char grid[GRID_SIZE][GRID_SIZE], uint8_t ship_id[GRID_SIZE][GRID_SIZE],
                   int row, int col);
